...
def get_places(location, query=None, radius=3000, limit=10, offset=0, type1=None):
    ...
    Args:
        ...
        type: place category, if more than one category separate them by comma ("coffee,parking") (<str>)
...
if __name__ == "__main__":
    ...
    result = get_places(location="LA", query="musical concert", offset=4, limit=6)
    print result
    # for i in result:
    #     print i
